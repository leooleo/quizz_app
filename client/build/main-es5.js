...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppLoginPageLoginPageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function LoginPageComponent(apiService, loginService, router) {
  ...
  function srcAppQuestionMakerQuestionMakerComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _question_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../question-model */
    ...
    function () {
      ...
      _createClass(QuestionMakerComponent, [{
        ...
        value: function onSubmit(formDirective) {
          ...
          this.apiService.sendQuestion(model).subscribe(function (response) {
            ...
            if (response.message == 'ok') {
              _this2.snackBar.open('Pergunta registrada!', 'Ok', {
                duration: 3000
              });
              ...
              _this2.profileForm.get('correctOption').setValue('1');

              _this2.userQuestionCount += 1;
            } else {
              _this2.snackBar.open('Erro desconhecido ' + response.message, 'Ok', {
                duration: 3000
              });
            }
          });
        ...
        value: function createModel() {
          return new _question_model__WEBPACK_IMPORTED_MODULE_3__["QuestionModel"](this.profileForm.value.question, this.user.name, [this.profileForm.value.firstAnswer, this.profileForm.value.secondAnswer, this.profileForm.value.thirdAnswer], this.profileForm.value.correctOption);
        }
      }, {
        ...
        value: function getUserAnsweredQuestions() {
          ...
          this.apiService.getUserQuestions(this.user.name).subscribe(function (questions) {
            _this3.userQuestionCount = questions.length;
        ...
        value: function validateUser() {
          if (this.user == undefined) {
            ...
            this.user = new _user_model__WEBPACK_IMPORTED_MODULE_1__["UserModel"]('Bonfa', 0, false, false); // this.router.navigate(['/login']);
    ...
    QuestionMakerComponent.ɵfac = function QuestionMakerComponent_Factory(t) {
      return new (t || QuestionMakerComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_login_service__WEBPACK_IMPORTED_MODULE_4__["LoginService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_api_service__WEBPACK_IMPORTED_MODULE_5__["ApiService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_7__["MatSnackBar"]));
    };
  ...
  function srcAppQuizzQuizzComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function QuizzComponent(socket, loginService, router) {
  ...
  /***/
  function srcAppUserModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var UserModel = function UserModel(name, score, hasAnswered, isLogged) {
      ...
      this.photoUrl = "http://localhost:8080/api/photo/".concat(name);
    };
    /***/
